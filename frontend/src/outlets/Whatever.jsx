      ...
      <main className="flex-grow">
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <div className="md:w-1/2 md:pl-8">
                <p className="text-lg mb-4">
                  Grocer Grove has been serving our local community with the
                  freshest produce and pantry essentials for over 30 years.
                  We're excited to now offer the convenience of home delivery
                  without compromising on the quality you've come to expect from
                  us.
                </p>
                <p className="text-lg">
                  Our mission is to bring the farmers' market experience right
                  to your kitchen, supporting local growers and providing you
                  with the best nature has to offer.
                </p>
              </div>
            </div>
          </div>
              ...
              {[
                ...
                >
                  ...
                  <p className="text-gray-600">
                    Discover our wide range of {category.toLowerCase()}.
                  </p>
                </div>
              ))}
            </div>
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-600">
                  Browse and order from our full selection online
                </p>
              </div>
              <div className="flex flex-col items-center">
        ...
        <section id="contact" className="bg-green-100 py-16">
          <div className="container mx-auto text-center">
            ...
            <p className="mt-4">
              Visit us at: 1 Washington Square, San Jose, USA
            </p>
          </div>
        </section>
      </main>
